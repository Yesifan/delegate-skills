...
group's prompt**. The implementer has no memory of prior runs, so a constraint that emerged in group
2 must be restated in group 5's prompt or it won't hold. This is the queue equivalent of keeping
